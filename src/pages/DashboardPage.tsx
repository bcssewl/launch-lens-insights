          ...
          <div className={isMobile ? "mobile-container space-y-4" : "p-4 md:p-6 lg:p-8 space-y-6 md:space-y-8"}>
            ...
            <section className="grid gap-3 md:gap-6 md:grid-cols-2 xl:grid-cols-4">
              {[...Array(isMobile ? 3 : 4)].map((_, i) => (
                <Skeleton key={i} className="h-24 md:h-32 w-full rounded-2xl md:rounded-3xl bg-surface-elevated" />
              ))}
            </section>
            
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-8">
              <Skeleton className="lg:col-span-2 h-48 md:h-60 rounded-2xl md:rounded-3xl bg-surface-elevated" />
              <Skeleton className="h-48 md:h-60 rounded-2xl md:rounded-3xl bg-surface-elevated" />
            </section>
          </div>
        </div>
      </DashboardLayout>
