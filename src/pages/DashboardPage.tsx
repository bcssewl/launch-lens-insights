...
import { Lightbulb, BarChart3, FileText, Target, PlayCircle, Briefcase, Users, DollarSign, RefreshCw, Plus } from 'lucide-react';
      ...
      <DashboardLayout>
        <div className="page-background-full">
          <div className="relative z-10">
            <DashboardHeader />
            <div className="content-max-width p-8 section-spacing">
              ...
              <section className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <Button variant="outline" size="lg" className="w-full sm:w-auto premium-card hover-lift">
              ...
              <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 premium-card p-6">
                  <Skeleton className="h-72 w-full bg-muted/20" />
                </div>
      ...
      <div className="page-background-full">
        <div className="relative z-10">
          ...
          <div className="content-max-width p-8 section-spacing">
            {/* Quick Action Section */}
            <section className="flex flex-col sm:flex-row items-center gap-4">
              <Button size="lg" className="w-full sm:w-auto gradient-button hover-lift" asChild>
                <Link to="/dashboard/validate">
                  <Lightbulb className="mr-2 h-5 w-5" />
                  💡 Validate New Idea
                </Link>
              ...
              <Button variant="outline" size="sm" onClick={refreshData} className="premium-card hover-lift">
            ...
            <section className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              ...
              <MetricCard
                ...
                subtitle={stats.businessPlans > 0 ? "Plans generated" : "You haven't started any business plans yet. Click '+ New' to begin."}
                icon={FileText}
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <ShadcnCard className="lg:col-span-2 premium-card">
                <ShadcnCardHeader className="pb-4">
                  <ShadcnCardTitle className="text-xl font-semibold heading-gradient">Recent Activity</ShadcnCardTitle>
                </ShadcnCardHeader>
                <ShadcnCardContent className="space-y-2">
                  {recentActivities.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      <div className="w-16 h-16 mx-auto mb-4 premium-card rounded-full flex items-center justify-center">
                        <Lightbulb className="w-8 h-8 text-primary" />
                      </div>
                      <p className="text-muted-foreground text-sm mb-4">No recent activity yet.</p>
                      <Button variant="outline" className="premium-card hover-lift" asChild>
                        <Link to="/dashboard/validate">
              ...
              <div className="space-y-6">
                <ShadcnCard className="premium-card">
                  <ShadcnCardHeader className="pb-4">
                    <ShadcnCardTitle className="text-xl font-semibold heading-gradient">Your Insights</ShadcnCardTitle>
                  </ShadcnCardHeader>
                  <ShadcnCardContent className="space-y-4">
                    {stats.ideasValidated > 0 ? (
                      ...
                      <div className="text-center py-8">
                        <div className="w-12 h-12 mx-auto mb-3 premium-card rounded-lg flex items-center justify-center">
                ...
                <ShadcnCard className="premium-card">
                  <ShadcnCardHeader className="pb-4">
                    <ShadcnCardTitle className="text-lg font-semibold heading-gradient">AI Assistant</ShadcnCardTitle>
                  </ShadcnCardHeader>
                  <ShadcnCardContent>
                    <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                      Get personalized advice for your startup ideas
                    </p>
                    <Button className="w-full gradient-button hover-lift" asChild>
