...
const PerplexityEmptyState: React.FC<PerplexityEmptyStateProps> = ({
  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col items-center justify-center min-h-[70vh] px-6 py-12 text-center max-w-7xl mx-auto bg-transparent">
        ...
        <div className="w-full max-w-6xl mb-12">
          ...
          <div className="relative bg-background border border-border rounded-xl px-6 py-4 shadow-sm hover:shadow-md transition-all duration-200 mb-3">
            ...
            <input 
              type="text" 
              placeholder={isRecording ? "Listening..." : "Ask v0 a question..."} 
