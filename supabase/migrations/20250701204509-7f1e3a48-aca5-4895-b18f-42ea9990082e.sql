...
-- Fix the mock chat history by updating the existing session and inserting messages
-- First, update the existing session to have the correct user_id
UPDATE chat_sessions 
SET user_id = 'f327d170-f6ba-45be-8f46-ca947dfdc72b'
WHERE id = '7b150a73-1a63-43dd-9dfb-e7ef41801990'
AND title = 'Mock Chat edits';

-- Now insert the conversation history directly using the session ID
INSERT INTO n8n_chat_history (session_id, message, created_at) VALUES
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'USER: Morning! Need a comprehensive market-entry plan for our AI-automation SaaS targeting EU mid-market.', NOW() - INTERVAL '2 hours 15 minutes'),
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'AI: Good morning! I''ll help you develop a comprehensive market-entry strategy for your AI-automation SaaS targeting the EU mid-market. Let me scope out the Total Addressable Market (TAM), competitor landscape, pricing opportunities, scenarios, and create an execution roadmap for you.
...
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'USER: Include my exec''s pet metric—ARR growth scenarios.', NOW() - INTERVAL '2 hours 11 minutes'),
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'AI: Perfect! I''ll model three ARR growth scenarios for you:
...
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'USER: Perfect. Also—add a decision matrix comparing solution-led, pure platform, and OEM white-label entries. Weight market fit highest.', NOW() - INTERVAL '2 hours 8 minutes'),
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'AI: Excellent approach! I''ll create a weighted decision matrix comparing the three entry strategies:
...
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'USER: Show me your chain-of-thought; leadership likes "glass-box" AI.', NOW() - INTERVAL '2 hours 5 minutes'),
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'AI: Absolutely! Transparency in AI reasoning is crucial for executive buy-in. I''ll include a comprehensive **Thought Process Snapshot** that shows:
...
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'USER: Let''s check interim visuals.', NOW() - INTERVAL '2 hours'),
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'AI: Here are the interim visuals I''ve prepared:
...
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'USER: Looks good. Can you deepen financials—cost structure and cash-burn runway?', NOW() - INTERVAL '1 hour 50 minutes'),
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'AI: Absolutely! I''ll expand the financial analysis with detailed operational modeling:
...
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'USER: And ESG angle—any EU taxonomy perks?', NOW() - INTERVAL '1 hour 45 minutes'),
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'AI: Great strategic thinking! EU taxonomy alignment offers significant advantages:
...
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'USER: Deliver the full draft.', NOW() - INTERVAL '1 hour 40 minutes'),
('7b150a73-1a63-43dd-9dfb-e7ef41801990', 'AI: # Comprehensive EU Market-Entry Strategy
